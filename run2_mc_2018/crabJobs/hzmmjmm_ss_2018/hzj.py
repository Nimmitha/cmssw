...
process.load('IOMC.EventVertexGenerators.VtxSmearedRealistic25ns13TeVEarly2018Collision_cfi') #seems right acording to https://github.com/cms-sw/cmssw/blob/master/Configuration/StandardSequences/python/VtxSmeared.py
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SIM_2018_13TeV_hzmmjpsimm_mc_v2.root'),
...
#process.GlobalTag = GlobalTag(process.GlobalTag, '102X_upgrade2018_realistic_v11', '')# GT that Spanier had on
# process.GlobalTag = GlobalTag(process.GlobalTag, '106X_upgrade2018_realistic_v15_L1v1', '') #GT recommended https://twiki.cern.ch/twiki/bin/viewauth/CMS/PdmVLegacy2018Analysis
process.GlobalTag = GlobalTag(process.GlobalTag, '106X_upgrade2018_realistic_v16_L1v1', '') #GT updated UL https://twiki.cern.ch/twiki/bin/viewauth/CMS/PdmVRun2LegacyAnalysis
