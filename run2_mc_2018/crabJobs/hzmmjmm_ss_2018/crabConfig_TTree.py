...
config.General.requestName = '2018_13TeV_hzmmjpsimm_ss_mc'                   # Used as the task/Project directory name
...
config.JobType.psetName = 'hzj.py'              # parameter-set config file
# config.JobType.generator = 'lhe'
# config.JobType.eventsPerLumi = 100
config.JobType.outputFiles = ['SIM_2018_13TeV_hzmmjpsimm_mc_v2.root']   # List of output files that needs to be collected
...
config.Data.outputDatasetTag = 'MinBias_TuneCP5_13TeV-pythia8_2018_hzmmjpsimm_ss_mc'
