...
config.General.requestName = '2017_13TeV_hzmmjpsimm_ss_mc'                   # Used as the task/Project directory name
...
config.JobType.psetName = 'hzj-2017.py'              # parameter-set config file
# config.JobType.generator = 'lhe'
# config.JobType.eventsPerLumi = 100
config.JobType.outputFiles = ['SIM_2017_13TeV_hzmmjpsimm_mc_v1.root']   # List of output files that needs to be collected
...
config.Data.outputDatasetTag = 'MinBias_TuneCP5_13TeV-pythia8_2017_hzmmjpsimm_ss_mc'
