...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SIM_2017_13TeV_hzmmjpsimm_mc_v1.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '106X_mc2017_realistic_v10', '') #GT updated UL https://twiki.cern.ch/twiki/bin/viewauth/CMS/PdmVRun2LegacyAnalysis
