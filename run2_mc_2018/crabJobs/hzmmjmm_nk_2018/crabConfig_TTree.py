...
config.General.requestName = '2018_13TeV_hzmmjpsimm_mc'                   # Used as the task/Project directory name
...
config.JobType.psetName = 'GEN_2018_HzmmJPsimm_cfg.py'              # parameter-set config file
# config.JobType.generator = 'lhe'
# config.JobType.eventsPerLumi = 100
config.JobType.outputFiles = ['SIM_2018_13TeV_hzmmjpsimm_mc_v1.root']   # List of output files that needs to be collected
...
config.Data.outputDatasetTag = 'MinBias_TuneCP5_13TeV-pythia8_2018_hzmmjpsimm_mc'
