...
config.General.requestName = 'TTree_13TeV_Muon1_mmmm_2023C_v3'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon1_Run2023C_v3_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon1/Run2023C-22Sep2023_v3-v1/MINIAOD'               # Name of the dataset
