...
// used to generate this class and read the Tree.
   if (tree == 0) {
     ...
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("~/nobackup/datasets/data/singleMuon_Run2/mmmmJesse/eras/crab_TTree_13TeV_mmmm_2018D.root");
	...
	f = new TFile("~/nobackup/datasets/data/singleMuon_Run2/mmmmJesse/eras/crab_TTree_13TeV_mmmm_2018D.root");
