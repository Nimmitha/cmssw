...
// Ups2 -> z & Ups1 -> Ups
   ...
   Events_b=0;
   B_Ups1_mass_b=0; B_Ups2_mass_b=0;
   B_Ups1_Pt_b=0; B_Ups2_Pt_b=0;
   B_Ups1_Phi_b=0; B_Ups2_Phi_b=0; 
   B_Ups1_VtxProb_b=0; B_Ups2_VtxProb_b=0;
   B_Ups1To2dY_b=0; 
   B_Z_mass_b=0; B_J_mass_b=0;
   FourL_mass_b=0; FourL_VtxProb_b=0;
   FourL_pt_b=0; FourL_eta_b=0; FourL_phi_b=0; FourL_rapidity_b=0;
   B_Mu1_pt_b = 0; B_Mu2_pt_b = 0; B_Mu3_pt_b = 0; B_Mu4_pt_b = 0;
   B_Mu1_eta_b = 0; B_Mu2_eta_b = 0; B_Mu3_eta_b = 0; B_Mu4_eta_b = 0;   
   B_Mu1_phi_b = 0; B_Mu2_phi_b = 0; B_Mu3_phi_b = 0; B_Mu4_phi_b = 0;
   mu1mC2_b =0; mu1pC2_b =0; mu1mNHits_b=0; mu1pNHits_b=0; mu1mNPHits_b=0; mu1pNPHits_b=0;
   mu2mC2_b =0; mu2pC2_b =0; mu2mNHits_b=0; mu2pNHits_b=0; mu2mNPHits_b=0; mu2pNPHits_b=0; 
   B_Mu1_soft_b=0;  B_Mu1_loose_b=0; B_Mu1_tight_b=0;
   B_Mu2_soft_b=0;  B_Mu2_loose_b=0; B_Mu2_tight_b=0;
   B_Mu3_soft_b=0;  B_Mu3_loose_b=0; B_Mu3_tight_b=0;
   B_Mu4_soft_b=0;  B_Mu4_loose_b=0; B_Mu4_tight_b=0;    
   B_J_xyP1_b=0; B_J_xyM1_b=0; B_J_zP1_b=0; B_J_zM1_b=0;
   B_J_xyP2_b=0; B_J_xyM2_b=0; B_J_zP2_b=0; B_J_zM2_b=0; 
   B_J1_mass_b=0; B_J2_mass_b=0; B_J3_mass_b=0;
   B_J4_mass_b=0;
   B_Z_pt1_b=0; B_Z_eta1_b=0; B_Z_phi1_b=0;
   B_Z_pt2_b=0; B_Z_eta2_b=0; B_Z_phi2_b=0;
   B_J_pt1_b=0; B_J_eta1_b=0; B_J_phi1_b=0;
   B_J_pt2_b=0; B_J_eta2_b=0; B_J_phi2_b=0;
   ...
   Long64_t ncandiPreSelection(0), nevPreSelection(0), ncandiTrigger(0), nevTrigger(0), ncandiSoft(0), nevSoft(0), ncandiDetector(0), nevDetector(0), ncandiLite4Vertex(0), nevLite4Vertex(0), ncandiCombine(0), nevCombine(0), ncandiIsolation1(0), nevIsolation1(0), ncandiIsolation2(0), nevIsolation2(0), ncandiIsolation3(0), nevIsolation3(0), ncandiIsolation4(0), nevIsolation4(0), ncandiMuonPtGreaterThan(0), nevMuonPtGreaterThan(0), ncandiYZVertexing(0), nevYZVertexing(0), ncandiYZPt(0), nevYZPt(0), ncandiYZMass(0), nevYZMass(0), ncandi4Vertex(0), nev4Vertex(0),ncandi4Pt(0), nev4Pt(0), ncandi4Mass(0), nev4Mass(0);
   Long64_t temp_eventPreSelection(0), temp_eventTrigger(0), temp_eventSoft(0), temp_eventDetector(0), temp_eventLite4Vertex(0), temp_eventCombine(0), temp_eventIsolation1(0), temp_eventIsolation2(0), temp_eventIsolation3(0), temp_eventIsolation4(0), temp_eventMuonPtGreaterThan(0), temp_eventYZVertexing(0), temp_eventYZPt(0), temp_eventYZMass(0), temp_event4Vertex(0), temp_event4Pt(0), temp_event4Mass(0);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	//preselection cuts
      ...
      // cut 2 Trigger
     if (B_U_TriggerPath->at(i)==0) continue;
	...
	if (B_Mu1_soft->at(i) < 1 || B_Mu2_soft->at(i) < 1 || B_Mu3_soft->at(i) < 1 || B_Mu4_soft->at(i) < 1) continue;
	...
	if (B_Mu1_pt->at(i) < 3.0 || B_Mu2_pt->at(i) < 3.0 || B_Mu3_pt->at(i) < 3.0 || B_Mu4_pt->at(i) < 3.0) continue;
	if (abs(B_Mu1_eta->at(i) )>2.4 || abs(B_Mu2_eta->at(i) )>2.4 ||abs(B_Mu3_eta->at(i) )>2.4 || abs(B_Mu4_eta->at(i) )>2.4  ) continue;
	...
	if (B_J4_VtxProb->at(i) > 0.01) {
      ...
      if (UpsVtx<1) continue;
      if (FourL_VtxProb->at(i) < 0.01) continue;
...
/*
	...
	B_Mu_IsoTrackCorr4 = B_Mu_IsoTrackCorr4 - M1.Pt();	
      ...
      */
      ...
      if ( (B_Mu_IsoTrackCorr1/B_Mu1_pt->at(i) ) >0.50) continue;
      ncandiIsolation1++;
      //Events=Event->at(i);
...
/*
   ...
   */   
      ...
      //cut 4 Z, J Vtx Prob
      if (Ups_VtxProb1 < 0.01 || Ups_VtxProb2 < 0.01 )continue;
      ...
      if (Ups_Pt1 < 5. || Ups_Pt2 < 5.) continue;
      ...
      //Dilepton mass cut 5
      if (Ups1_mass < 9.0 || Ups1_mass>9.7) continue;
      if (Ups2_mass < 70.0 || Ups2_mass>110) continue;
	...
	nev4Vertex++;
      ...
      //FourL_mass Cut
      if (FourL_mass->at(i) < 112 || FourL_mass->at(i) > 142) continue;
...
cout<<"Number of event 4Mass="<<nev4Mass<<endl;
   ...
   if (ncandiPreSelection>0 ||  ncandiTrigger>0 ||   ncandiSoft>0 ||  ncandiDetector>0 ||  ncandiLite4Vertex>0 ||  ncandiCombine>0  || ncandiMuonPtGreaterThan>0   || ncandiYZVertexing>0 || ncandiYZPt>0 || ncandiYZMass>0 || ncandi4Vertex>0 || ncandi4Mass>0){
     fTree->Fill();
   }
