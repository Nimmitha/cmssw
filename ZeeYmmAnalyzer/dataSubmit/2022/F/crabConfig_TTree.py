...
config.General.requestName = 'TTree_13TeV_zeeymm_2022F'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2022_F.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['EGamma_Run2022F_PromptReco_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/EGamma/Run2022F-PromptReco-v1/MINIAOD'               # Name of the dataset
...
config.Data.lumiMask = 'Cert_Collisions2022_355100_362760_Golden.json' # Lumi-section filter
