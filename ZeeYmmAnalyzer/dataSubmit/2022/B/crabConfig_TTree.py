...
config.General.requestName = 'TTree_13TeV_zeeymm_2022B'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['EGamma_Run2022B_v2_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/EGamma/Run2022B-22Sep2023-v2/MINIAOD'               # Name of the dataset
