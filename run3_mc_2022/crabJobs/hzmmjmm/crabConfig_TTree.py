...
config.General.requestName = '2022_13p6TeV_hzmmjmm_mc'                   # Used as the task/Project directory name
...
config.JobType.psetName = 'SIM_2022_HzmmJmm_cfg.py'              # parameter-set config file
# config.JobType.generator = 'lhe'
# config.JobType.eventsPerLumi = 100
config.JobType.outputFiles = ['SIM_2022_13p6TeV_hzmmjmm_mc_v1.root']   # List of output files that needs to be collected
...
config.Data.outputDatasetTag = 'MinBias_TuneCP5_13p6TeV-pythia8_2022_hzmmjmm_mc'
