...
# with command line options: Configuration/GenProduction/python/Run3-Hzmmymm-fragment.py --mc --python_filename SIM_2022_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 124X_mcRun3_2022_realistic_v12 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3 --nThreads 8 --fileout file:SIM.root --no_exec -n 5
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Run3-Hzmmymm-fragment.py nevts:5'),
