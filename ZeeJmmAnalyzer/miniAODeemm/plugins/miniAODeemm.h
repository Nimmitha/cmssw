...
private:
  ...
  std::vector<bool>        *B_Z_looseCutBase1, *B_Z_mediumCutBase1, *B_Z_tightCutBase1;
  std::vector<bool>        *B_Z_mvaIsoWP80_1, *B_Z_mvaIsoWP90_1;
  ...
  std::vector<bool>        *B_Z_looseCutBase2, *B_Z_mediumCutBase2, *B_Z_tightCutBase2;
  std::vector<bool>        *B_Z_mvaIsoWP80_2, *B_Z_mvaIsoWP90_2;
