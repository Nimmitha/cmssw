...
setupEgammaPostRecoSeq(process,
                       ...
                       runVID=True,
                       era='2016postVFP-UL') # 2018-UL  2017-UL  2016postVFP-UL  2016preVFP-UL
...
process.source = cms.Source(
    ...
    fileNames = cms.untracked.vstring(
        "file:miniAOD/test_miniAOD_2016G.root"
    ),
)

process.TFileService = cms.Service(
    "TFileService",
    fileName = cms.string("preselection/testfile_2016G.root"),
)
...
process.rootuple = cms.EDAnalyzer(
    ...
    # ElectronTrigger=cms.string("HLT_Ele32_WPTight_Gsf_L1DoubleEG_v"), # 2017 + hltEGL1SingleEGOrFilter added automatically
