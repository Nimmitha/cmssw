...
#ifndef AnalysisWithIso_bkg_h
#define AnalysisWithIso_bkg_h
...
public:
  ...
  AnalysisWithIso_bkg(TTree *tree = 0);
  virtual ~AnalysisWithIso_bkg();
...
#ifdef AnalysisWithIso_bkg_cxx
AnalysisWithIso_bkg::AnalysisWithIso_bkg(TTree *tree) : fChain(0) {
...
AnalysisWithIso_bkg::~AnalysisWithIso_bkg() {
  if (!fChain)
    return;
  delete fChain->GetCurrentFile();
}

Int_t AnalysisWithIso_bkg::GetEntry(Long64_t entry) {
  // Read contents of entry.
  if (!fChain)
    return 0;
  return fChain->GetEntry(entry);
}
Long64_t AnalysisWithIso_bkg::LoadTree(Long64_t entry) {
...
void AnalysisWithIso_bkg::Init(TTree *tree) {
...
Bool_t AnalysisWithIso_bkg::Notify() {
...
void AnalysisWithIso_bkg::Show(Long64_t entry) {
...
Int_t AnalysisWithIso_bkg::Cut(Long64_t entry) {
  // This function may be called from Loop.
  // returns  1 if entry is accepted.
  // returns -1 otherwise.
  return 1;
}
#endif  // #ifdef AnalysisWithIso_bkg_cxx
