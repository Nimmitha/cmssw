...
#ifndef AnalysisWithIso_sig_h
#define AnalysisWithIso_sig_h
...
public:
  ...
  // vector<float> *Mu_TriggerPath;
  vector<bool> *Ele_TriggerPath;
  vector<float> *B_Z_TriggerPt1;
  vector<float> *B_Z_TriggerEta1;
  vector<float> *B_Z_TriggerPhi1;
  vector<float> *B_Z_TriggerPt2;
  vector<float> *B_Z_TriggerEta2;
  vector<float> *B_Z_TriggerPhi2;
  vector<float> *B_Z_TriggerPt3;
  vector<float> *B_Z_TriggerEta3;
  vector<float> *B_Z_TriggerPhi3;
  vector<float> *B_Z_TriggerPt4;
  vector<float> *B_Z_TriggerEta4;
  vector<float> *B_Z_TriggerPhi4;
  vector<float> *B_Z_TriggerPt5;
  vector<float> *B_Z_TriggerEta5;
  vector<float> *B_Z_TriggerPhi5;
  vector<float> *B_Z_mass;
  vector<float> *B_Z_px;
  vector<float> *B_Z_py;
  vector<float> *B_Z_pz;
  vector<float> *B_Z_pt;
  vector<float> *B_Z_eta;
  vector<float> *B_Z_phi;
  vector<float> *B_Z_rapidity;

  vector<float> *B_Z_eta1;
  vector<float> *B_Z_pt1;
  vector<float> *B_Z_phi1;
  vector<float> *B_Z_eta2;
  vector<float> *B_Z_pt2;
  vector<float> *B_Z_phi2;
  ...
  vector<float> *B_J_pz;
  vector<float> *B_J_pt;
  vector<float> *B_J_eta;
  vector<float> *B_J_phi;
  vector<float> *B_J_rapidity;

  vector<float> *B_J_pt1;
  vector<float> *B_J_eta1;
  vector<float> *B_J_phi1;
  vector<float> *B_J_pt2;
  vector<float> *B_J_eta2;
  vector<float> *B_J_phi2;
  ...
  vector<float> *B_Z_VtxProb;
  vector<float> *B_J_VtxProb;
  ...
  // vector<float> *B_Z_looseHEEPwp1;
  vector<float> *B_J_loose1;
  // vector<bool> *B_Z_looseHZZwp1;
  // vector<bool> *B_Z_looseHZZwp2;
  vector<bool> *B_Z_mvaIsoWP90_1;
  vector<bool> *B_Z_mvaIsoWP90_2;

  vector<bool> *B_Z_looseCutBase1;
  vector<bool> *B_Z_looseCutBase2;
  vector<bool> *B_J_soft1;
  vector<bool> *B_J_soft2;

  // List of branches

  // TBranch *b_B_Z_looseHEEPwp1;
  TBranch *b_B_J_loose1;
  TBranch *b_B_Z_mvaIsoWP90_1;
  TBranch *b_B_Z_mvaIsoWP90_2;
  //  TBranch        *B_Z_looseHZZwp1;
  ...
  // TBranch *b_Mu_TriggerPath;   //!
  TBranch *b_Ele_TriggerPath;  //!
  TBranch *b_B_Z_TriggerPt1;    //!
  TBranch *b_B_Z_TriggerEta1;   //!
  TBranch *b_B_Z_TriggerPhi1;   //!
  TBranch *b_B_Z_TriggerPt2;    //!
  TBranch *b_B_Z_TriggerEta2;   //!
  TBranch *b_B_Z_TriggerPhi2;   //!
  TBranch *b_B_Z_TriggerPt3;    //!
  TBranch *b_B_Z_TriggerEta3;   //!
  TBranch *b_B_Z_TriggerPhi3;   //!
  TBranch *b_B_Z_TriggerPt4;    //!
  TBranch *b_B_Z_TriggerEta4;   //!
  TBranch *b_B_Z_TriggerPhi4;   //!
  TBranch *b_B_Z_TriggerPt5;    //!
  TBranch *b_B_Z_TriggerEta5;   //!
  TBranch *b_B_Z_TriggerPhi5;   //!
  TBranch *b_B_Z_mass;          //!
  TBranch *b_B_Z_px;            //!
  TBranch *b_B_Z_py;            //!
  TBranch *b_B_Z_pz;            //!
  ...
  TBranch *b_B_Z_trackiso1;
  // TBranch *b_B_Z_looseHZZwp1;
  // TBranch *b_B_Z_looseHZZwp2;

  TBranch *b_B_Z_looseCutBase1;
  TBranch *b_B_Z_looseCutBase2;
  TBranch *b_B_J_soft1;
  TBranch *b_B_J_soft2;
  ...
  TBranch *b_B_Z_VtxProb;  //!
  TBranch *b_B_J_VtxProb;  //!
  ...
  AnalysisWithIso_sig(TTree *tree = 0);
  virtual ~AnalysisWithIso_sig();
...
#ifdef AnalysisWithIso_sig_cxx
AnalysisWithIso_sig::AnalysisWithIso_sig(TTree *tree) : fChain(0) {
  // if parameter tree is not specified (or zero), connect the file
  // used to generate this class and read the Tree.
  if (tree == 0) {
    // TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject("../preselection/crab_TTree_13TeV_eemm_UL_run2.root");
    TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject("../preselection/zeejmm_mc_2018.root");

    if (!f || !f->IsOpen()) {
      // f = new TFile("../preselection/crab_TTree_13TeV_eemm_UL_run2.root");
      f = new TFile("../preselection/zeejmm_mc_2018.root");
    }
...
AnalysisWithIso_sig::~AnalysisWithIso_sig() {
  if (!fChain)
    return;
  delete fChain->GetCurrentFile();
}

Int_t AnalysisWithIso_sig::GetEntry(Long64_t entry) {
  // Read contents of entry.
  if (!fChain)
    return 0;
  return fChain->GetEntry(entry);
}
Long64_t AnalysisWithIso_sig::LoadTree(Long64_t entry) {
...
void AnalysisWithIso_sig::Init(TTree *tree) {
  ...
  // fChain->SetBranchAddress("Mu_TriggerPath", &Mu_TriggerPath, &b_Mu_TriggerPath);
  fChain->SetBranchAddress("Ele_TriggerPath", &Ele_TriggerPath, &b_Ele_TriggerPath);
  fChain->SetBranchAddress("B_Z_TriggerPt1", &B_Z_TriggerPt1, &b_B_Z_TriggerPt1);
  fChain->SetBranchAddress("B_Z_TriggerEta1", &B_Z_TriggerEta1, &b_B_Z_TriggerEta1);
  fChain->SetBranchAddress("B_Z_TriggerPhi1", &B_Z_TriggerPhi1, &b_B_Z_TriggerPhi1);
  fChain->SetBranchAddress("B_Z_TriggerPt2", &B_Z_TriggerPt2, &b_B_Z_TriggerPt2);
  fChain->SetBranchAddress("B_Z_TriggerEta2", &B_Z_TriggerEta2, &b_B_Z_TriggerEta2);
  fChain->SetBranchAddress("B_Z_TriggerPhi2", &B_Z_TriggerPhi2, &b_B_Z_TriggerPhi2);
  fChain->SetBranchAddress("B_Z_TriggerPt3", &B_Z_TriggerPt3, &b_B_Z_TriggerPt3);
  fChain->SetBranchAddress("B_Z_TriggerEta3", &B_Z_TriggerEta3, &b_B_Z_TriggerEta3);
  fChain->SetBranchAddress("B_Z_TriggerPhi3", &B_Z_TriggerPhi3, &b_B_Z_TriggerPhi3);
  fChain->SetBranchAddress("B_Z_TriggerPt4", &B_Z_TriggerPt4, &b_B_Z_TriggerPt4);
  fChain->SetBranchAddress("B_Z_TriggerEta4", &B_Z_TriggerEta4, &b_B_Z_TriggerEta4);
  fChain->SetBranchAddress("B_Z_TriggerPhi4", &B_Z_TriggerPhi4, &b_B_Z_TriggerPhi4);
  fChain->SetBranchAddress("B_Z_TriggerPt5", &B_Z_TriggerPt5, &b_B_Z_TriggerPt5);
  fChain->SetBranchAddress("B_Z_TriggerEta5", &B_Z_TriggerEta5, &b_B_Z_TriggerEta5);
  fChain->SetBranchAddress("B_Z_TriggerPhi5", &B_Z_TriggerPhi5, &b_B_Z_TriggerPhi5);
  fChain->SetBranchAddress("B_Z_mass", &B_Z_mass, &b_B_Z_mass);
  fChain->SetBranchAddress("B_Z_px", &B_Z_px, &b_B_Z_px);
  fChain->SetBranchAddress("B_Z_py", &B_Z_py, &b_B_Z_py);
  fChain->SetBranchAddress("B_Z_pz", &B_Z_pz, &b_B_Z_pz);
  fChain->SetBranchAddress("B_Z_pt", &B_Z_pt, &b_B_Z_pt);
  fChain->SetBranchAddress("B_Z_eta", &B_Z_eta, &b_B_Z_eta);
  fChain->SetBranchAddress("B_Z_phi", &B_Z_phi, &b_B_Z_phi);
  fChain->SetBranchAddress("B_Z_rapidity", &B_Z_rapidity, &b_B_Z_rapidity);
  ...
  fChain->SetBranchAddress("B_J_pt", &B_J_pt, &b_B_J_pt);
  fChain->SetBranchAddress("B_J_eta", &B_J_eta, &b_B_J_eta);
  fChain->SetBranchAddress("B_J_phi", &B_J_phi, &b_B_J_phi);
  fChain->SetBranchAddress("B_J_rapidity", &B_J_rapidity, &b_B_J_rapidity);

  fChain->SetBranchAddress("B_Z_eta1", &B_Z_eta1, &B_Z_eta1_b);
  fChain->SetBranchAddress("B_Z_pt1", &B_Z_pt1, &B_Z_pt1_b);
  fChain->SetBranchAddress("B_Z_phi1", &B_Z_phi1, &B_Z_phi1_b);
  fChain->SetBranchAddress("B_Z_eta2", &B_Z_eta2, &B_Z_eta2_b);
  fChain->SetBranchAddress("B_Z_pt2", &B_Z_pt2, &B_Z_pt2_b);
  fChain->SetBranchAddress("B_Z_phi2", &B_Z_phi2, &B_Z_phi2_b);
  fChain->SetBranchAddress("B_J_pt1", &B_J_pt1, &B_J_pt1_b);
  fChain->SetBranchAddress("B_J_eta1", &B_J_eta1, &B_J_eta1_b);
  fChain->SetBranchAddress("B_J_phi1", &B_J_phi1, &B_J_phi1_b);
  fChain->SetBranchAddress("B_J_pt2", &B_J_pt2, &B_J_pt2_b);
  fChain->SetBranchAddress("B_J_eta2", &B_J_eta2, &B_J_eta2_b);
  fChain->SetBranchAddress("B_J_phi2", &B_J_phi2, &B_J_phi2_b);

  // fChain->SetBranchAddress("B_Z_looseHEEPwp1", &B_Z_looseHEEPwp1, &b_B_Z_looseHEEPwp1);
  fChain->SetBranchAddress("B_J_loose1", &B_J_loose1, &b_B_J_loose1);
  // fChain->SetBranchAddress("B_Z_looseHZZwp1", &B_Z_looseHZZwp1, &b_B_Z_looseHZZwp1);
  // fChain->SetBranchAddress("B_Z_looseHZZwp2", &B_Z_looseHZZwp2, &b_B_Z_looseHZZwp2);
  fChain->SetBranchAddress("B_Z_mvaIsoWP90_1", &B_Z_mvaIsoWP90_1, &b_B_Z_mvaIsoWP90_1);
  fChain->SetBranchAddress("B_Z_mvaIsoWP90_2", &B_Z_mvaIsoWP90_2, &b_B_Z_mvaIsoWP90_2);

  fChain->SetBranchAddress("B_Z_looseCutBase1", &B_Z_looseCutBase1, &b_B_Z_looseCutBase1);
  fChain->SetBranchAddress("B_Z_looseCutBase2", &B_Z_looseCutBase2, &b_B_Z_looseCutBase2);

  fChain->SetBranchAddress("B_J_soft1", &B_J_soft1, &b_B_J_soft1);
  fChain->SetBranchAddress("B_J_soft2", &B_J_soft2, &b_B_J_soft2);
  ...
  //    fChain->SetBranchAddress("B_Z_trackiso1", &B_Z_trackiso1, &b_B_Z_trackiso1);
  ...
  fChain->SetBranchAddress("B_Z_VtxProb", &B_Z_VtxProb, &b_B_Z_VtxProb);
  fChain->SetBranchAddress("B_J_VtxProb", &B_J_VtxProb, &b_B_J_VtxProb);
...
Bool_t AnalysisWithIso_sig::Notify() {
...
void AnalysisWithIso_sig::Show(Long64_t entry) {
...
Int_t AnalysisWithIso_sig::Cut(Long64_t entry) {
  // This function may be called from Loop.
  // returns  1 if entry is accepted.
  // returns -1 otherwise.
  return 1;
}
#endif  // #ifdef AnalysisWithIso_sig_cxx
