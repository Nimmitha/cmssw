...
void AnalysisWithIso::Loop() {
  ...
  ofstream myfile1;
  myfile.precision(17);
  myfile.open("ZeeYuu_data_candidatesE.dat");
  myfile1.open("ZeeYuu_data_candidatesEventNumberOfMultiples.dat");
  TFile *fFile = new TFile("ZeeYuu_data_TriggerOfficalL1_candidatesE.root", "recreate");
  ...
  for (Long64_t jentry = 0; jentry < nentries; jentry++) {
    ...
    for (int i = 0; i < Event->size(); i++) {
      ...
      // cout << "TriggerPath: " << B_Z_TriggerPath->at(i) << endl;
      // cout << "TriggerPath1: " << B_Z_TriggerPath1->at(i) << endl;
      // cout << "B_J_soft1: " << B_J_soft1->at(i) << endl;
      // cout << "B_J_mass: " << B_J_mass->at(i) << endl;

      //cut 2 Trigger
      if (B_Z_TriggerPath->at(i) < 1) {
        continue;
      }
