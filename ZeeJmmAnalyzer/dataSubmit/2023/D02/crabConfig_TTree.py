...
config.General.requestName = 'TTree_13TeV_EGamma0_zeeymm_2023D_v2'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2023_M0_D_v2.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['EGamma0_Run2023D_v2_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/EGamma0/Run2023D-22Sep2023_v2-v1/MINIAOD'               # Name of the dataset
