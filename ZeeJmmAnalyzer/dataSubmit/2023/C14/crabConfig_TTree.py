...
config.General.requestName = 'TTree_13TeV_EGamma1_zeeymm_2023C_v4'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2023_M1_C_v4.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['EGamma1_Run2023C_v4_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/EGamma1/Run2023C-22Sep2023_v4-v1/MINIAOD'               # Name of the dataset
