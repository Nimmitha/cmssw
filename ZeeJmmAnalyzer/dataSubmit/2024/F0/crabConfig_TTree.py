...
config.General.requestName = 'TTree_13TeV_PR_EGamma0_zeejmm_2024F'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2024_E0_F.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['EGamma0_Run2024F_PromptReco_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/EGamma0/Run2024F-PromptReco-v1/MINIAOD'               # Name of the dataset
