...
config.General.requestName = 'TTree_13TeV_eemm_UL_2018D_v2'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['EGamma_Run2018D_UL_v2_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/EGamma/Run2018D-UL2018_MiniAODv2-v2/MINIAOD'               # Name of the dataset
