...
config.General.requestName = 'TTree_13TeV_eemm_UL_2017C_v2'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2017_C.py'                 # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                               # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['SingleElectron_Run2017C_UL_v2_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/SingleElectron/Run2017C-UL2017_MiniAODv2-v1/MINIAOD'           # Name of the dataset
