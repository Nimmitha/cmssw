...
config.General.requestName = 'TTree_13TeV_zeeymm_2022C'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['EGamma_Run2022C_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/EGamma/Run2022C-22Sep2023-v1/MINIAOD'               # Name of the dataset
