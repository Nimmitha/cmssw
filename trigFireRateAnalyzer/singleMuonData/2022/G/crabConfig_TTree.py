...
config.General.requestName = 'TTree_13TeV_trig_2022G'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon_Run2022G_PromptReco_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon/Run2022G-PromptReco-v1/MINIAOD'               # Name of the dataset
