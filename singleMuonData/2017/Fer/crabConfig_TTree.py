...
config.General.requestName = 'TTree_13TeV_fourmuon_2017Fer'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2017_Fer.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['SingleMuon_Run2017Fer_UL_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/SingleMuon/Run2017F-09Aug2019_UL2017_EcalRecovery-v1/MINIAOD'               # Name of the dataset
...
config.Data.lumiMask = 'Cert_294927-306462_13TeV_UL2017_Collisions17_MuonJSON.txt' # Lumi-section filter
