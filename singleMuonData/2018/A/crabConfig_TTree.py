...
config.General.requestName = 'TTree_13TeV_fourmuon_2018A'   # Used as the task/Project directory name
...
config.Data.inputDataset = '/SingleMuon/Run2018A-12Nov2019_UL2018-v5/MINIAOD'               # Name of the dataset
