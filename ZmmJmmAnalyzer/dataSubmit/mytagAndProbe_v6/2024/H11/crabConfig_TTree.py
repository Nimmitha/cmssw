...
config.General.requestName = 'Muon1_mm_2024H1_gemtag_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon1_Run2024H1_v1_Data.root']   # List of output files that needs to be collected
