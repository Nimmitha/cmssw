...
config.General.requestName = 'PSM6_mm_2024I1_eff_v1'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PSM6_Run2024I1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingSingleMuon6/Run2024I-MINIv6NANOv15-v1/MINIAOD'               # Name of the dataset
