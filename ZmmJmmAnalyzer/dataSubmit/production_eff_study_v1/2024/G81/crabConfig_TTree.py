...
config.General.requestName = 'PSM8_mm_2024G1_eff_v1'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PSM8_Run2024G1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingSingleMuon8/Run2024G-MINIv6NANOv15-v4/MINIAOD'               # Name of the dataset
