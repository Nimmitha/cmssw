...
config.General.requestName = 'PSM11_mm_2024H1_eff_v1'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PSM11_Run2024H1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingSingleMuon11/Run2024H-MINIv6NANOv15-v3/MINIAOD'               # Name of the dataset
