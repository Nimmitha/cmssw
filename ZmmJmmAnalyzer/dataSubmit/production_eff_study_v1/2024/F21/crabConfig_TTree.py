...
config.General.requestName = 'PSM2_mm_2024F1_eff_v1'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PSM2_Run2024F1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 1200                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingSingleMuon2/Run2024F-MINIv6NANOv15-v3/MINIAOD'               # Name of the dataset
