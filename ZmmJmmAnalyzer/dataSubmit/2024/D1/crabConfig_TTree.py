...
config.General.requestName = 'TTree_13TeV_PR_Muon1_mmmm_2024D'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2024_M1_D.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['Muon1_Run2024D_PromptReco_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon1/Run2024D-PromptReco-v1/MINIAOD'               # Name of the dataset
