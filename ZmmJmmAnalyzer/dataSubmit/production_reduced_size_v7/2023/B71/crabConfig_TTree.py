...
config.General.requestName = 'PDMLM7_mm_2023B1_v7'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM7_Run2023B1_v1_Data.root']   # List of output files that needs to be collected
