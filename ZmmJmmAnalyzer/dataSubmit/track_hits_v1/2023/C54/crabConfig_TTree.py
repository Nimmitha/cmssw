...
config.General.requestName = 'PDMLM5_mm_2023C4_hits_v1'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM5_Run2023C_v4_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass5/Run2023C-22Sep2023_v4-v1/MINIAOD'               # Name of the dataset
