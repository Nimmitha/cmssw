...
config.General.requestName = 'PDMLM1_mm_2022C1_hits_v1'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM1_Run2022C1_v3_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass1/Run2022C-10Dec2022-v3/MINIAOD'               # Name of the dataset
