...
config.General.requestName = 'PDMLM7_mm_2022C1_hits_v1'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM7_Run2022C1_v2_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass7/Run2022C-10Dec2022-v2/MINIAOD'               # Name of the dataset
...
config.Data.outLFNDirBase = '/store/user/nkarunar/pdmlm/tracker_hits/'
