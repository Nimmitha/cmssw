...
config.General.requestName = 'Muon_mm_2022F_tag_v3'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon_Run2022F_v2_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon/Run2022F-22Sep2023-v2/MINIAOD'               # Name of the dataset
