...
config.General.requestName = 'Muon_mm_2022G_tag_v3'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon_Run2022G_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon/Run2022G-22Sep2023-v1/MINIAOD'               # Name of the dataset
