...
config.General.requestName = 'Muon1_mm_2024I2_tag_v3'   # Used as the task/Project directory name
...
config.JobType.maxJobRuntimeMin = 20                                  # Maximum job runtime in minutes
