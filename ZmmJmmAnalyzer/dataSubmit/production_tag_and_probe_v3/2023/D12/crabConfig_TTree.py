...
config.General.requestName = 'Muon1_mm_2023D2_tag_v3'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon1_Run2023D2_v1_Data.root']   # List of output files that needs to be collected
