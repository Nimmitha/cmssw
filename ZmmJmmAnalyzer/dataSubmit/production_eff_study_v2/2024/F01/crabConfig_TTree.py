...
config.General.requestName = 'PSM0_mm_2024F1_eff_v2'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PSM0_Run2024F1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingSingleMuon0/Run2024F-MINIv6NANOv15-v4/MINIAOD'               # Name of the dataset
