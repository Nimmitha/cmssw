...
config.General.requestName = 'PSM3_mm_2024C1_eff_v2'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PSM3_Run2024C1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingSingleMuon3/Run2024C-MINIv6NANOv15-v1/MINIAOD'               # Name of the dataset
