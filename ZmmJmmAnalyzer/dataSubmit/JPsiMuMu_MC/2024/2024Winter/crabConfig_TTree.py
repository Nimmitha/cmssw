...
config.JobType.outputFiles = ['JPsiToMuMu_PT_0to100_Winter24_MC.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 120                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/JPsiToMuMu_PT-0to100_pythia8-gun/Run3Winter24MiniAOD-KeepSi_133X_mcRun3_2024_realistic_v8-v2/MINIAODSIM'               # Name of the dataset
