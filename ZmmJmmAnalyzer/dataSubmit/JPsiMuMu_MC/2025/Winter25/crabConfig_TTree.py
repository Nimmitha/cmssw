...
config.General.requestName = 'JPsiToMuMu_PT_0to120_Winter25_MC_withGen_Truth'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['JPsiToMuMu_PT_0to120_Winter25_MC.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 120                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/JPsiToMuMu_PT-0to100_pythia8-gun/Run3Winter25MiniAOD-FlatPU0to120_MiniAODv6_150X_mcRun3_2025_realistic_v6-v2/MINIAODSIM'               # Name of the dataset
...
config.Data.splitting = 'FileBased'                                                         # Split the task based on 
config.Data.unitsPerJob = 1                                                                # Number of splitted units per job
...
config.Data.outLFNDirBase = '/store/user/nkarunar/JPsiToMuMu_MC/'
