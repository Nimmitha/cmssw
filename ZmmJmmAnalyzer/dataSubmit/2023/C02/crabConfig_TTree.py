...
config.General.requestName = 'TTree_13TeV_Muon0_mmmm_2023C_v2'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon0_Run2023C_v2_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon0/Run2023C-22Sep2023_v2-v1/MINIAOD'               # Name of the dataset
