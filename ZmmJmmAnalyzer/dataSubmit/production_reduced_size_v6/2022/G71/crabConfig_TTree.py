...
config.General.requestName = 'PDMLM7_mm_2022G1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM7_Run2022G1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass7/Run2022G-22Sep2023-v1/MINIAOD'               # Name of the dataset
