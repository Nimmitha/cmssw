...
config.General.requestName = 'PDMLM5_mm_2022E1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM5_Run2022E1_v2_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass5/Run2022E-10Dec2022-v2/MINIAOD'               # Name of the dataset
