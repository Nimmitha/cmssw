...
config.General.requestName = 'PDMLM5_mm_2024C1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM5_Run2024C1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass5/Run2024C-PromptReco-v1/MINIAOD'               # Name of the dataset
