...
config.General.requestName = 'PDMLM2_mm_2024E2_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM2_Run2024E2_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass2/Run2024E-PromptReco-v2/MINIAOD'               # Name of the dataset
