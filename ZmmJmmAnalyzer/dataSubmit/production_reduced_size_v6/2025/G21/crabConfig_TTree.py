...
config.General.requestName = 'PDMLM2_mm_2025G1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM2_Run2025G1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass2/Run2025G-PromptReco-v1/MINIAOD'               # Name of the dataset
