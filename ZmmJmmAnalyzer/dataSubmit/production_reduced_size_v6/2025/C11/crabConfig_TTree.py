...
config.General.requestName = 'PDMLM1_mm_2025C1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM1_Run2025C1_v1_Data.root']   # List of output files that needs to be collected
