...
config.General.requestName = 'PDMLM4_mm_2025D1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM4_Run2025D1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 1200                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass4/Run2025D-PromptReco-v1/MINIAOD'               # Name of the dataset
