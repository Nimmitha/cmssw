...
config.General.requestName = 'PDMLM1_mm_2025D1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM1_Run2025D1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass1/Run2025D-PromptReco-v1/MINIAOD'               # Name of the dataset
