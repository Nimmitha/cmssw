...
config.General.requestName = 'PDMLM3_mm_2025E1_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM3_Run2025E1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass3/Run2025E-PromptReco-v1/MINIAOD'               # Name of the dataset
