...
config.General.requestName = 'PDMLM4_mm_2023D2_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM4_Run2023D_v2_v2_Data.root']   # List of output files that needs to be collected
