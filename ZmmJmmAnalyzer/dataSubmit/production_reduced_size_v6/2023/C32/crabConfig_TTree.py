...
config.General.requestName = 'PDMLM3_mm_2023C2_v6'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM3_Run2023C_v2_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass3/Run2023C-22Sep2023_v2-v1/MINIAOD'               # Name of the dataset
