...
config.General.requestName = 'PDMLM3_mm_2024F1_emit_v3'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM3_Run2024F1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass3/Run2024F-PromptReco-v1/MINIAOD'               # Name of the dataset
...
config.Data.lumiMask = 'lumi_Mask_emit_2024.json' # Lumi-section filter
