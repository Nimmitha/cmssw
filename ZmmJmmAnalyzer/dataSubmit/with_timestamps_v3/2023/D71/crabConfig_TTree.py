...
config.General.requestName = 'PDMLM7_mm_2023D1_emit_v3'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM7_Run2023D1_v1_v1_Data.root']   # List of output files that needs to be collected
