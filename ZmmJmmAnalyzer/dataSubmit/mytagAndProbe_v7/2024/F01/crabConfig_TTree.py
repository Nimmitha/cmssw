...
config.General.requestName = 'Muon0_mm_2024F1_gemtag_v7'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon0_Run2024F1_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 100                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon0/Run2024F-MINIv6NANOv15-v1/MINIAOD'               # Name of the dataset
