...
config.General.requestName = 'TTree_13TeV_mmmm_UL_2018A_v2'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['SingleMuon_Run2018A_UL_v2_v3_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/SingleMuon/Run2018A-UL2018_MiniAODv2-v3/MINIAOD'               # Name of the dataset
