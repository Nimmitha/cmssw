...
config.General.requestName = 'TTree_13TeV_mmmm_UL_2016Bv2_v2'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmmmmRootupler_2016_Bv2.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['SingleMuon_Run2016Bv2_HIPM_UL_v2_v2_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 60                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/SingleMuon/Run2016B-ver2_HIPM_UL2016_MiniAODv2-v2/MINIAOD'               # Name of the dataset
