...
config.General.requestName = 'PDMLM1_mm_2023D1_emit_v2'   # Used as the task/Project directory name
...
config.Data.lumiMask = 'Cert_Collisions2023_370293_370579_emit.json' # Lumi-section filter
