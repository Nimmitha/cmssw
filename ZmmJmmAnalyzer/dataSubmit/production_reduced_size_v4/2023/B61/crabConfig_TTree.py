...
config.General.requestName = 'PDMLM6_mm_2023B1_v4'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM6_Run2023B_v1_Data.root']   # List of output files that needs to be collected
