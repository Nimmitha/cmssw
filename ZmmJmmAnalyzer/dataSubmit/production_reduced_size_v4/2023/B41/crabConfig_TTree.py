...
config.General.requestName = 'PDMLM4_mm_2023B1_v4'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM4_Run2023B_v2_Data.root']   # List of output files that needs to be collected
