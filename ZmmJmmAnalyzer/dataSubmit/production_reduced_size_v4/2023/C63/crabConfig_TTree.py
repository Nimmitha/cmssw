...
config.General.requestName = 'PDMLM6_mm_2023C3_v4'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['PDMLM6_Run2023C_v3_v1_Data.root']   # List of output files that needs to be collected
config.JobType.maxJobRuntimeMin = 180                                  # Maximum job runtime in minutes
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass6/Run2023C-22Sep2023_v3-v1/MINIAOD'               # Name of the dataset
