...
config.General.requestName = 'TTree_136TeV_PDMLM0_mm_2024H_Run385986'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_PDMLM0_2024H_v1.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['PDMLM0_Run2024H_PromptReco_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass0/Run2024H-PromptReco-v1/MINIAOD'               # Name of the dataset
...
config.Data.runRange = '385986'
config.Data.splitting = 'LumiBased'                                                         # Split the task based on 
config.Data.unitsPerJob = 10                                                                # Number of splitted units per job
