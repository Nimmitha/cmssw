...
config.General.requestName = 'TTree_136TeV_PDMLM4_mm_2023D_v1'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_PDMLM4_2023D_v1.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['PDMLM4_Run2023D_v1_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/ParkingDoubleMuonLowMass4/Run2023D-22Sep2023_v1-v1/MINIAOD'               # Name of the dataset
