...
config.General.requestName = 'TTree_13TeV_mmmm_2022F'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon_Run2022F_PromptReco_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon/Run2022F-PromptReco-v1/MINIAOD'               # Name of the dataset
