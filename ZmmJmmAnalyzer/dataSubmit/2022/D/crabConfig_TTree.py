...
config.General.requestName = 'TTree_13TeV_mmmm_2022D'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['Muon_Run2022D_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/Muon/Run2022D-22Sep2023-v1/MINIAOD'               # Name of the dataset
