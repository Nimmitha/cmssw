...
void AnalysisWithIso_bkg::Loop() {
  ...
  myfile.open("mmmm_bkg.dat");
  myfile1.open("mmmm_bkgMultiples.dat");
  TFile *fFile = new TFile("mmmm_bkg.root", "recreate");
...
*/
   ...
   */
      ...
      //Dilepton mass cut 5
      if (Ups1_mass < 2.8 || Ups1_mass > 3.4)
        continue;
      ...
      //OnlyUps(1S)
      //if (Ups1_mass > 3.4) continue;
      //if (Ups2_mass > 3.4) continue;
      //rapidity cut cut 6
