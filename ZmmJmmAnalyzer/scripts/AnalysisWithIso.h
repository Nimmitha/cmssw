...
AnalysisWithIso::AnalysisWithIso(TTree *tree) : fChain(0) {
  ...
  if (tree == 0) {
    ...
    TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject("../inputFiles/mmmmJesse/crab_TTree_13TeV_mmmm_2018BCD.root");
    // TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject("/uscms/home/wkarunar/nobackup/datasets/mc/preselection/run2/zmmjmm/ZuJuu_MC_2018_s1.root");
    if (!f || !f->IsOpen()) {
      // f = new TFile("../outputs/crab_TTree_13TeV_mmmm_Run3.root");
      f = new TFile("../inputFiles/mmmmJesse/crab_TTree_13TeV_mmmm_2018BCD.root");
      // f = new TFile("/uscms/home/wkarunar/nobackup/datasets/mc/preselection/run2/zmmjmm/ZuJuu_MC_2018_s1.root");
    }
