// -*- C++ -*-
//
// Package:    miniAODmmmm_Pixelhits
// Class:      miniAODmmmm_Pixelhits
//
/**\class miniAODmmmm_Pixelhits miniAODmmmm_Pixelhits.cc ZmmJmmAnalyzer/miniAODmmmm_Pixelhits/plugins/miniAODmmmm_Pixelhits.cc
...
// user include files
#include "ZmmJmmAnalyzer/miniAODmmmm/plugins/miniAODmmmm_Pixelhits.h"
...
miniAODmmmm_Pixelhits::miniAODmmmm_Pixelhits(const edm::ParameterSet &iConfig)
...
miniAODmmmm_Pixelhits::~miniAODmmmm_Pixelhits() {}
...
void miniAODmmmm_Pixelhits::analyze(const edm::Event &iEvent, const edm::EventSetup &iSetup) {
  using std::vector;
  using namespace edm;
  ...
  if (!thePATMuonHandle.isValid()) {
    edm::LogWarning("miniAODmmmm_Pixelhits") << "No pat::Muon found on Event!";
    return;
  }
  if (!TriggerResults.isValid()) {
    edm::LogWarning("miniAODmmmm_Pixelhits") << "No TriggerResults found on Event!";
    return;
  }
  if (!triggerPrescales.isValid()) {
    edm::LogWarning("miniAODmmmm_Pixelhits") << "no Trigger prescale in event!";
    return;
  }
  ...
  if (primaryVertices_handle.isValid() && !primaryVertices_handle->empty()) {
    ...
    edm::LogWarning("miniAODmmmm_Pixelhits") << "Primary vertex collection is not valid!";
  }
...
void miniAODmmmm_Pixelhits::beginJob() {
...
void miniAODmmmm_Pixelhits::endJob() {
  tree_->GetDirectory()->cd();
  tree_->Write();
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void miniAODmmmm_Pixelhits::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
...
DEFINE_FWK_MODULE(miniAODmmmm_Pixelhits);