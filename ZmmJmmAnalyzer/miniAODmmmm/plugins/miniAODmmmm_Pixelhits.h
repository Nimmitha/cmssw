#ifndef _miniAODmmmm_Pixelhits_h
#define _miniAODmmmm_Pixelhits_h
...
class miniAODmmmm_Pixelhits : public edm::one::EDAnalyzer<edm::one::SharedResources> {
public:
  explicit miniAODmmmm_Pixelhits(const edm::ParameterSet &);
  ~miniAODmmmm_Pixelhits() override;
