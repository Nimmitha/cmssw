...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(       
        ...
        'file:miniAODs/0388b6db-c3b5-442f-902d-13a19855924c_PSMC0.root'
...
process.rootuple = cms.EDAnalyzer('TriggerEffAnalyzer',
...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string('preselection/eff_test.root'),
)
