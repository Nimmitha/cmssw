...
process.rootuple = cms.EDAnalyzer('mytagAndProbeV7',
    ...
    # isMC = cms.bool(False)
    pfcands = cms.InputTag("packedPFCandidates"), # The Generic Tracks
)

# --- Output File ---
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('preselection/tracking_miniaod_efficiency.root'),
)
