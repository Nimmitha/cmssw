...
config.General.requestName = 'TTree_13TeV_fourmuon_2016C'   # Used as the task/Project directory name
...
config.JobType.outputFiles = ['SingleMuon_Run2016C_UL_HIMP_v1_Data.root']   # List of output files that needs to be collected
# config.JobType.maxMemoryMB = 1000

# data to be analyzed
config.Data.inputDBS = 'global'
config.Data.inputDataset = '/SingleMuon/Run2016C-21Feb2020_UL2016_HIPM-v1/MINIAOD'               # Name of the dataset
