...
config.General.requestName = 'TTree_13TeV_fourmuon_2018B'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2018_B.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['SingleMuon_Run2018B_UL_v3_Data.root']   # List of output files that needs to be collected
