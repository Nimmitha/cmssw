...
config.General.requestName = 'TTree_13TeV_fourmuon_2018D'   # Used as the task/Project directory name
...
config.JobType.psetName = 'miniAODmuonsRootupler_2018_D.py'           # parameter-set config file
config.JobType.allowUndistributedCMSSW = True                       # Allow CMSSW release possibly not available at sites
config.JobType.outputFiles = ['SingleMuon_Run2018D_UL_v8_Data.root']   # List of output files that needs to be collected
